...
val cleartext_channel_of_fd :
  Lwt_unix.file_descr -> tls_role option -> Channel.cleartext_channel
...
val init_tls_get_ctx :
  ?curve:string -> certfile:string -> ciphersuites:string -> unit -> Ssl.context
...
val with_channel :
     Lwt_unix.file_descr
  -> tls_role option
  -> (Nbd.Channel.cleartext_channel -> 'a Lwt.t)
  -> 'a Lwt.t
