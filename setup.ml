...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1632164dbbbdb5b5406c9e7d618e5bd0) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "nbd-lwt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "nbd_test_lwt.ml"});
               Executable
                 ({
                     cs_name = "nbd-mux-test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "nbd_mux_test.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\200\143\157\143\176@\164$\194\004K\139\148\251@\166";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
