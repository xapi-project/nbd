...
(* OASIS_START *)
(* DO NOT EDIT (digest: c718971c887978578fed1d00aa5c0cbb) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Nbd_lwt_client"; "Nbd_lwt_server"; "Nbd_lwt_mux"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\1780(\028C\133S\195n\003\235\248\134{\130T";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
